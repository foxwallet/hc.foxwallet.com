...
## II. Definition
* 2.1 FoxWallet: The blockchain wallet developed by 6Block LLC. based on ETH/Filecoin and other blockchain systems which FoxWallet may support in the future, and other supporting tools which are developed for the convenience of the Users when using blockchain systems.
...
* 2.4 Terms:         
    ...
    * c) Specific Users: Users who should cooperate with 6Block LLC. and disclose Personal Information in order to comply with the laws, regulations and policies of Singapore.         
    ...
    * g) Keystore: A file that is encrypted by Private Key or Mnemonic Words and protected by the User’s Wallet Password. Keystore is stored only in Users’ mobile device and will not be synchronized to 6Block LLC. servers.     
...
* 3.4 Browse DApps. Users may use FoxWallet to visit and use the services provided by DApps (including DApps developed by 6Block LLC. and DApps developed by third parties).Browse the DApp. Users can link to the DApp and use the services provided by the DApp (including 6Block LLC. own DApps and third-party DApps) through the link on FoxWallet.

* 3.5 Transaction records. We will copy all or part of your transaction records from the blockchain system. However, Users shall refer to the blockchain system for the latest transaction records.

* 3.6 Suspension of service. You understand that we are not able to reverse or cancel the transaction because transactions based on blockchain technologies are irrevocable. However, under certain circumstances, we may suspend or limit the function of FoxWallet used by a particular User.

* 3.7 Other services that 6Block LLC. would like to provide.

## IV. Users who use FoxWallet must understand that:
* 4.1 In order to keep the decentralization feature of blockchain and to protect the security of your digital Tokens, 6Block LLC. offers decentralized service which is largely different from the banking and financial institutions. Users shall understand that 6Block LLC. (the decentralized solution) DOES NOT provide the following services:
...
* 4.2 Users shall take care of their mobile devices, back up the FoxWallet App, and back up the Wallet Password, Mnemonic Words, Private Key and Keystore by themselves. If your mobile device is lost, your FoxWallet App or your wallet is deleted and not backed up, your wallet is stolen or you forget your Wallet Password, Private Key, Mnemonic Words or Keystore, 6Block LLC. is not able to recover the wallet or restore Wallet Password, Private Key, Mnemonic Words or Keystore. Nor can 6Block LLC. cancel transactions for the mishandling of Users (such as typing in wrong addresses for transactions).
...
* 5.1 Create or Import Wallet 
    ...
    * c) 6Block LLC. may develop different versions of FoxWallet for different terminal devices. You shall download and install applicable version. If you download and install FoxWallet or other application with the same name as “FoxWallet” from any unauthorized third party, 6Block LLC. cannot guarantee the normal operation or security of such application. Any loss caused by using such application shall be borne by you.         
    * d) A previous version of FoxWallet may stop to operate after a new version is released. 6Block LLC. cannot guarantee the security, continuous operation or customer services for the previous version. Users shall download and use the latest version.
         
* 5.2 Use of FoxWallet  
    * a) Users shall take care of their mobile devices, Wallet Password, Private Key, Mnemonic Words and Keystore by themselves. 6Block LLC. does not store or hold the above information for Users. You shall be responsible for any risks, liabilities, losses and expenses which result from frauds, you losing your mobile device, disclosing (whether actively or passively) or forgetting Wallet Password, Private Key, Mnemonic Words or Keystore, or your wallet being attacked.         
...
* 5.3 Transfer of Tokens
    ...
    * d) You understand that FoxWallet is only a tool for transfer of Tokens. 6Block LLC. shall be deemed to have fulfilled its obligations once you have finished the transfer and shall not be held liable for any other disputes.         
...
* 6.4 When you use third-party-developed DApps integrated in FoxWallet, 6Block LLC. strongly suggest you read this Agreement and FoxWallet’s Alert carefully, get familiar with the counterparty and the product information and evaluate the risks before you make transactions on such DApps.
...
* 6.8 You understand that after you create or import wallet on FoxWallet, your Keystore, Private Key and Mnemonic Words are only stored on your mobile device and will not be stored in FoxWallet or on the servers of 6Block LLC.. You may change another mobile device to use FoxWallet after you follow the instructions on FoxWallet to backup your wallet. If you lose your mobile device before you could write down or backup your Wallet Password, Private Key, Mnemonic Words or Keystore, you may lose your Tokens and 6Block LLC. is unable to restore them. If your Wallet Password, Private Key, Mnemonic Words or Keystore is disclosed or the device which stores or holds your Wallet Password, Private Key, Mnemonic Words or Keystore is hacked or attacked, you may lose your Tokens and 6Block LLC. is unable to restore them. You shall bear the foregoing losses on your own.
...
* 7.2 You understand that 6Block LLC. may suspend services under the following circumstances:         
    ...
    * b) due to force majeure events including but not limited to typhoon, earthquake, tsunami, flood, power outage, war, or terrorist attacks, or computer viruses, Trojan Horse, hacker attacks, system instability or government behaviors and other reasons, 6Block LLC. is unable to provide services or in 6Block LLC.’ reasonable opinion, continuous provision of services would result in significant risks;         
    * c) due to other events which 6Block LLC. cannot control or reasonably predicate.         
    * d) 6Block LLC. reserves the right to unilaterally suspend or terminate all or part of the function of FoxWallet under the following circumstances:                  
        * a. death of Users;                  
        ...
        * g. if you pretend to be staff or management personnel of 6Block LLC.;                  
        * h. if you threaten the normal operation of 6Block LLC. computer system by attack, invasion, alternation or any other means;                  
        * i. if you use FoxWallet to send spams;          
        * j. if you spread rumors which endanger the goodwill of 6Block LLC. and FoxWallet;                  
        * k. if you conduct any illegal activities, breach this Agreement etc. or other circumstances under which 6Block LLC. reasonably considers necessary to suspend services.

* 7.3 You are entitled to export your wallets within a reasonable amount of time if 6Block LLC. changes, suspends or terminates its services.
...
* 8.2 You shall not use FoxWallet to commit any illegal or unlawful activities, including but not limited to:
    ...
    * c) accessing 6Block LLC. services, collecting or processing the content provided by 6Block LLC., intervening or attempting to intervene any Users, by the employment of any automated programs, software, network engines, web crawlers, web analytics tools, data mining tools or similar tools etc.;         
    ...
    * h) other activities which 6Block LLC. has reason to believe are inappropriate.   
         
* 8.3 You understand and accept that you shall be responsible for any violation of law (including but not limited to the regulations of the Customs and Tax) or for breach of this Agreement by you and shall indemnify 6Block LLC. against the losses, the third-party claims or administrative penalties against 6Block LLC. incurred by such violation or breach, including reasonable attorney’s fees.
     
* 8.4 You are not an Excluded Person who is eligible to use the FoxWallet service.8.5 You confirm that you will pay the service fees charged by 6Block LLC. in time (if applicable). 6Block LLC. reserves the right to suspend the services when the User fails to pay service fees (if applicable).

## IX. Privacy Policy
**Your privacy is of utmost importance for 6Block LLC..**
...
* 10.1 6Block LLC. only undertakes obligations expressly set forth in this Agreement.   

* 10.2 YOU ACKNOWLEDGE AND ACCEPT THAT, TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, FoxWallet IS PROVIDED ON AN "AS IS", "AS AVAILABLE" AND "WITH ALL FAULTS" BASIS. 6Block LLC. shall not be held liable for malfunction of FoxWallet which results from the following reasons:
    ...
    * d) your improper, unauthorized or unrecognized use of 6Block LLC. services;         
    ...
    * f) any other reasons not imputed to 6Block LLC..   
           
* 10.3 6Block LLC. shall not be held liable under the following circumstances:
...
* 10.4 Under the registration method using FoxWallet mobile phone number and email address (the effective decentralized solution under the EOS system), users can choose to export the private key. The property damage arising from loss or stolen private key after the user changes the authority of Owner and Active shall not be borne by 6Block LLC. in any way.

* 10.5 Under the default mode of the registration method using FoxWallet mobile phone number and email address (the effective decentralized solution under the EOS system), if the private key cannot be retrieved through mobile phone number due to the user’s causes (such as the user cannot gain a new SIM card), 6Block LLC. will not provide the service to retrieve the private key.

* 10.6 Property loss caused by users themselves (including but not limited to loss of mobile phone number, email address, the disclosure of the verification code, publication of the private key by the user, and the user’s personal information being hacked) shall not be borne by 6Block LLC. in any way.
...
**You acknowledge that FoxWallet may provide services to you and your counterparties simultaneously and you agree to waive any actual or potential conflicts of interests and will not claim against 6Block LLC. on such base or burden 6Block LLC. with more responsibilities or duty of care.**

## XI. 6Block LLC. does not warrant that:
a) services provided by 6Block LLC. would satisfy all your needs;  
b) all techniques, products, services, information or other materials from 6Block LLC. would meet your expectations;  
...
e) in any case, the total liability for 6Block LLC. under this Agreement shall not exceed the greater of: a. 0.1 Ether; or b. 500 SGD, higher value shall prevail.  

* 11.1 You are aware that FoxWallet is only a tool for Users to manage their Tokens and to display transaction information. 6Block LLC. does not provide legal, tax or investment advice. You shall seek advice from professional legal, tax, and investment advisors. In addition, 6Block LLC. shall not be liable for any investment loss, data loss etc. during your use of our service.
...
* 12.1 This Agreement incorporates FoxWallet Terms of Service, FoxWallet Privacy Policy, and other rules (including contents in the “Support” column) posted by 6Block LLC. from time to time.
...
This Agreement shall become effective on October 10th, 2021. 

As for any issues not covered in this Agreement, you shall comply with the announcements and relevant rules as updated by 6Block LLC. from time to time.
