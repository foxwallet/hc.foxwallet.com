...
### 支持 Aleo DApp 交互
FoxWallet是全球第一款支持Aleo的移动端去中心化钱包。在这个版本中，FoxWallet支持了Aleo上的dApp交互。作为开发者，您可以创建自己的dApp，并通过FoxWallet进行信息读取、转账、合约调用等操作。点击查阅具体细节：https://hc.foxwallet.com/docs/developr/provider/aleo-provider  
